var loader = {
	init: function() {
		...
		function loadComplete() { 
			...
			.fromTo($('#intro h1'), 0.5, {scale:0.4, autoAlpha: 0}, {scale:0.8, autoAlpha: 1, ease:Power1.easeIn}, '-=0.2') 
			.fromTo($('#intro h4'), 0.5, {scale:0.4, autoAlpha: 0}, {scale:0.8, autoAlpha: 1, ease:Power1.easeIn}, '-=5.5') 
